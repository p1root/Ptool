...
import sys
address = ['admin/', 'administrator/', 'login.php', 'administration/', 'admin1/', 'admin2/', 'admin3/', 'admin4/',
           ...
           'siteadmin/login.asp', 'siteadmin/index.asp', 'siteadmin/login.html', 'memberadmin/', 'administratorlogin/',
           'adm/', 'admin/account.php', 'admin/index.php', 'admin/login.php', 'admin/admin.php', 'admin/account.php',
...
# ---------------------GET URL------------------------------
    site = str(input('\n'+Fore.LIGHTBLACK_EX +
               '  [Ptool] '+Fore.LIGHTRED_EX+"Enter Url or IP "+Fore.LIGHTBLUE_EX+":>> "))
    site = site + \
        '/' if "https" in site else (site +
                                     '/' if 'http' in site else 'https://' + site + "/")
    ...
    try:
        for i in address:
            ...
            if respon.status_code == 200:
                print('\n'+Fore.LIGHTBLUE_EX +
                      '[found] ' + Fore.LIGHTGREEN_EX + url)
            else:
                print('\n'+Fore.RED + '[not found] ' +
                      Fore.LIGHTGREEN_EX + url)
    except Exception:
        print('ERORR !!')
        sys.exit()
# --------------------EXIT-------------------------------
